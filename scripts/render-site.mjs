    ...
    <main id="main-content">
      ...
      <div class="toolbar">
        ...
        <div class="toolbar-actions">
          <div class="theme-toggle" role="group" aria-label="Chọn giao diện màu">
            <button type="button" class="theme-toggle__button" data-theme="fresh">Tươi</button>
            <button type="button" class="theme-toggle__button" data-theme="calm">Êm</button>
            <button type="button" class="theme-toggle__button" data-theme="contrast">Rõ</button>
          </div>
