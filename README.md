...
- `mains` dung object `{ "name", "group", "starch" }`; them `wateryStarch: true` cho mon tinh bot nuoc can tranh xep lien tiep va dam bao moi tuan du 5 ngay co it nhat 1 mon tinh bot nuoc.
