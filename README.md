...
- Khi con lua chon hop le, script uu tien tranh trung `breakfast`, `soup`, va `side` trong cung tuan va so voi tuan lien truoc; rieng `main` con uu tien tranh trung trong toan bo ke hoach 4 tuan.
